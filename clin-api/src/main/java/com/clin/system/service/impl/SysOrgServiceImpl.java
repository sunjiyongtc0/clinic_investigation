...
import com.clin.system.mapper.SysOrgMapper;
...
//	}
	...
	public LinkedHashMap<String, Object> querySysOrgTree() {
		...
		List<LinkedHashMap<String, Object>> totalList = sysOrgMapper.querySysOrgTree();
	...
	public List<LinkedHashMap<String, Object>> queryOrgUserTree(Long roleId, Short assign) {
		List<LinkedHashMap<String, Object>> totalList = sysOrgMapper.queryOrgUserTree();
