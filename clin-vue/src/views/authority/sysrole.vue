      ...
      <el-container style="width: 100%">
        ...
        <div ref="mainDiv" style="width: 87%">
          <div class="filter-container">
            ...
            <el-button v-waves class="filter-item" icon="el-icon-refresh-right" @click="handleResetUrl">
              {{ $t('common.reset') }}
            </el-button>
          </div>
          <el-table
...
<script>
import { querySysRole, querySysMenuTree, queryOrgUserTree, queryMenuIdByRoleId, authorizeMenuToRole, querySysMenuButtonTree, queryMenuButtonByRoleCode, querySysMenu, queryUrlIdByRoleId, querySysUrl, authorizeMenuButtonToRole, authorizeUserToRole, authorizeUrlToRole, addSysRole, updateSysRole, deleteSysRole, exportSysRole } from '@/api/system'
