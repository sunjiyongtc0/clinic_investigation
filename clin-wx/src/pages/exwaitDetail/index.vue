  ...
  <div @click="" id="page" style="overflow-y: hidden;">
    ...
    <div style="overflow-y: auto; height:calc(100vh - 100rpx)">
      <div v-show="showStep1">
        ...
        <div style="position: fixed; z-index:9;  text-align: center; color: white; bottom: 0rpx; width: 100%; height: 90rpx; line-height: 90rpx; background: #44DAB7;" @click="submit(1)"> 查看问卷信息</div>
      </div>
...
export default {
  ...
  methods: {
    ...
    confirmDate(){
      this.pdcItems[2].answer = this.todateDate(this.birthday);
      this.showDate = false;
    },
    ...
    getInfoData(){
      let vm = this;
      vm.utils.GET('clin/mp/examine/findBakDetailById', {id:this.showDetailId}).then(l_res=>{
